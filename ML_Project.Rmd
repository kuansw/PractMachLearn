...
Finally, the first seven columns including timestamps, X and user_name 
are dimensional data, which do not contribute to our prediction model.
They shall also be removed from the training dataset.
...
we found that the overall accuracy is only around 76.0%, with significant 
...
the Random Forest Model achieved a very high overall accuracy of **99.3%**, which 
